<div style="display:flex; justify-content:space-between; align-items:center;">
  <img src="assets/logo.png" alt="Logo left" style="width:120px;"/>
  <img src="assets/logo.png" alt="Logo right" style="width:120px;"/>
</div>

<div style="text-align:center; margin-top:60px;">
  <h1 style="font-size:40px; margin-bottom:6px;">Badji Mokhtar University</h1>
  <h2 style="font-size:20px; margin-top:0; margin-bottom:4px;">Mini-projet sur le Supervised, Unsupervised and Deep Learning</h2>
  <h3 style="font-size:16px; margin-top:0; font-weight:normal;">Application aux Systèmes de Détection d'Intrusion (IDS)</h3>

  <p style="margin-top:24px;"><strong>Étudiants:</strong> Souilah Darine &amp; Zehar Malek</p>
  <p><strong>Badji Mokhtar University — Computer Science Department</strong></p>
...
16. smeansz - Taille moyenne des paquets source
17. dmeansz - Taille moyenne des paquets destination
18. trans_depth - Profondeur de transaction
19. res_bdy_len - Longueur du corps de réponse
...
12. dns_answer - Réponse DNS
13. ssl_ver - Version SSL
14. ssl_cipher - Cipher SSL
15. ssh_ver - Version SSH
16. ssh_auth - Authentification SSH
17. mqtt_cmd - Commande MQTT
18. mqtt_len - Longueur MQTT
19. coap_ver - Version CoAP
20. coap_type - Type CoAP
...
| Modèle | Accuracy | Recall | Precision | F1-Score | AUC | Temps d'Entraînement |
|--------|----------|--------|-----------|----------|-----|----------------------|
...
2. **Impact de la sélection de features** : L'utilisation des Top 20 caractéristiques réduit la dimensionnalité de 64% en moyenne avec une baisse de performance négligeable (Δ recall = -0.0019%, Δ AUC = -0.0012%), justifiant son utilisation pour des déploiements en temps réel.
